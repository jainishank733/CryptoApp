...
public class HomePageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view == itemAll) {
            Intent i = new Intent(HomePageActivity.this, AllCryptosActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(HomePageActivity.this, NewsActivity.class);
            startActivity(i);
            Toast.makeText(this, "News", Toast.LENGTH_SHORT).show();
        } else if (view == itemConverter) {
            Intent i = new Intent(HomePageActivity.this, ConverterActivity.class);
            startActivity(i);
